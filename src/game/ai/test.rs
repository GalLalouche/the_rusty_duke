...
pub mod tests {
    ...
    pub fn can_find_winning_move<A>() where A: ArtificialPlayer {
        ...
        let mv = A::create(1).get_next_move(&mut StdRng::seed_from_u64(0), &gs);
    ...
    pub fn can_find_winning_move_with_lookahead_2<A>() where A: ArtificialPlayer {
        let mut board = GameBoard::empty();
        ...
        let mv = A::create(2).get_next_move(&mut StdRng::seed_from_u64(0), &gs);
